...
def begin():
    n=2
    print("press 1) Player1 ='x'and player2 (Computer)='0'\n 2)Player1='0' and player2(Computer)='x'")
    tr=int(input())
    if tr==1:
        player1='X'
        player2='O'
...
def check_result(p1,p2):
    value=6 # this is a temorary value that is being set to help comparisions.
    for i in range(8):
        if game[i]==" ":
            game[i]=6
